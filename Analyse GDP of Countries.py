...
gdp_per_capita.argmax()


# In[60]:


countries[gdp_per_capita.argmax()]


# In[61]:


countries[gdp_per_capita.argmin()]
...
for country in countries:
    print('ecalculating countries {}' .format(country))
...
for i in range(len(countries)):
    ...
    print('country {} per capita gdp is {}'.format(country,countries_gdp_per_capita))
